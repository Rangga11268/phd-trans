        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Contoh <span className="text-shiny-purple">Voucher Reservasi</span>
            </h2>
            <p className="text-gray-400 max-w-2xl mx-auto">
              Dokumen resmi perjalanan wisata Anda yang menjamin kenyamanan dan keamanan armada pilihan.
            </p>
          </div>
                      ...
                      <div className="flex justify-between items-start mb-10">
                        <div className="flex items-center gap-4">
                          <div className="h-14 w-14 rounded-xl overflow-hidden relative shadow-md">
                            <Image src="/assets/img/logoPHD.jpg" alt="Logo" fill className="object-cover" />
                          </div>
                          <div>
                            <h3 className="font-bold text-slate-900 text-2xl tracking-tight">PHD Trans</h3>
                            <p className="text-primary text-sm font-bold tracking-widest uppercase">Official Reservation</p>
                          </div>
                        </div>
                        <div className="text-right">
                          ...
                          <p className="text-slate-400 text-xs mt-2 font-mono">#BOOK-2024-8829</p>
                        </div>
                      </div>

                      <div className="space-y-8">
                        <div>
                          <p className="text-xs text-gray-400 uppercase tracking-widest mb-2">Penyewa / Rombongan</p>
                          <h4 className="font-bold text-slate-900 text-3xl">Keluarga Besar SMAN 1 Nganjuk</h4>
                        </div>

                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                          <div>
                            <p className="text-xs text-gray-400 uppercase tracking-widest mb-2">Unit Armada</p>
                          ...
                          <div>
                            <p className="text-xs text-gray-400 uppercase tracking-widest mb-2">Durasi Wisata</p>
                            <div className="flex items-center gap-3">
                              <div className="bg-primary/10 p-2 rounded-lg">
                                <Calendar className="h-5 w-5 text-primary" />
                              </div>
                              <div>
                                <p className="font-bold text-slate-900 text-lg">4 Hari 3 Malam</p>
                                <p className="text-sm text-gray-500">25 - 28 Desember 2024</p>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div>
                          <p className="text-xs text-gray-400 uppercase tracking-widest mb-2">Rute Perjalanan</p>
                          <div className="flex items-center gap-4 bg-white p-4 rounded-xl border border-gray-100 shadow-sm">
                            <span className="font-bold text-slate-700">NGANJUK</span>
                            ...
                            <span className="font-bold text-primary text-xl">BALI</span>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="relative z-10">
                      ...
                      <ul className="space-y-3 text-gray-300 text-sm mb-8">
                        <li className="flex items-center gap-2">
                          <CheckCircle className="h-4 w-4 text-primary" /> AC Luxury
                        </li>
                        <li className="flex items-center gap-2">
                          <CheckCircle className="h-4 w-4 text-primary" /> Reclining Seat 2-2
                        </li>
                        <li className="flex items-center gap-2">
                          <CheckCircle className="h-4 w-4 text-primary" /> Karaoke & TV
                        </li>
                        <li className="flex items-center gap-2">
                          <CheckCircle className="h-4 w-4 text-primary" /> Bantal & Selimut
                        </li>
                        <li className="flex items-center gap-2">
                          <CheckCircle className="h-4 w-4 text-primary" /> Dispenser & Coolbox
                        </li>
                      </ul>
                    </div>
