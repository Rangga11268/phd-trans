import { MessageCircle, Bus, CreditCard, CheckCircle, Plane } from 'lucide-react';
  ...
  const steps = [
    {
      ...
      icon: MessageCircle,
      title: 'Konsultasi',
      description: 'Hubungi kami via WhatsApp atau telepon untuk konsultasi kebutuhan perjalanan Anda.',
    ...
    },
    {
      ...
      description: 'Pilih unit bus yang sesuai dengan jumlah penumpang dan tentukan jadwal perjalanan.',
    ...
    },
    {
      ...
      icon: CreditCard,
      title: 'DP & Konfirmasi',
      description: 'Bayar Down Payment (DP) 30% untuk mengamankan jadwal dan armada pilihan Anda.',
    ...
    },
    {
      ...
      icon: CheckCircle,
      title: 'Pelunasan',
      description: 'Lunasi pembayaran maksimal 3 hari sebelum tanggal keberangkatan.',
    ...
    },
    {
      ...
      description: 'Bus akan tiba sesuai jadwal. Nikmati perjalanan nyaman bersama PHD Trans!',
              ...
              return (
                <div key={step.number} className="relative">
                  ...
                  <div className="flex justify-center mb-8">
                    <div className={`w-32 h-32 rounded-full bg-gradient-to-br ${step.color} flex items-center justify-center shadow-lg shadow-primary/20 relative z-10 border-4 border-slate-900`}>
                  ...
                  <div className="bg-white/5 backdrop-blur-sm p-6 rounded-2xl border border-white/10 hover:border-primary/50 transition-all">
                    ...
                    <p className="text-gray-400 text-sm leading-relaxed text-center">{step.description}</p>
                  </div>
                </div>
              );
            })}
